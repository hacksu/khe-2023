...
export function ThemeProvider(props: { theme: Omit<MantineThemeOverride, 'colorScheme'>, colorScheme: ColorScheme, firstVisit?: boolean, children: any }) {
    ...
    const _colorScheme = doColorScheme ? colorScheme : 'light';
    ...
    const theme: MantineThemeOverride = merge({ ...props.theme }, { colorScheme: _colorScheme, ...themes[colorScheme] });
    ...
    return <ColorSchemeProvider colorScheme={_colorScheme} toggleColorScheme={toggleColorScheme}>
